...
export default {
  data() {
    return {
      iconClass:
        getLocalStorageValue(THEME_STORAGE_NAME) === ThemeEnum.LIGHT ? icons.light : icons.dark,
      presets: Object.keys(presets),
      selectedPrimaryColor: getLocalStorageValue(COLOR_STORAGE_NAME) || PrimaryColorEnum.GREEN,
      selectedSurfaceColor: getLocalStorageValue(SURFACE_STORAGE_NAME),
      primaryColors: [
        { name: PrimaryColorEnum.NOIR, palette: {} },
        {
          name: PrimaryColorEnum.EMERALD,
          palette: {
            50: '#ecfdf5',
            100: '#d1fae5',
            200: '#a7f3d0',
  ...
  methods: {
    onThemeToggler() {
      ...
      root.classList.toggle(SELECTOR_DARK_THEME)
      this.iconClass = this.iconClass === icons.dark ? icons.light : icons.dark
      setLocalStorageValue(
        THEME_STORAGE_NAME,
        root.classList.contains(SELECTOR_DARK_THEME) ? ThemeEnum.DARK : ThemeEnum.LIGHT
      )
    },
    getPresetExt() {
    ...
    updateColors(type: string, color: any) {
      if (type === 'primary') {
        ...
        setLocalStorageValue(SURFACE_STORAGE_NAME, color.name)
      }
  ...
  created() {
    const theme = getLocalStorageValue(THEME_STORAGE_NAME)
